...
function Comenzarjuego(){
  ...
  for (let i = 0; i < 16; i++) {
    cartaTemporal=document.getElementById(i)
    cartaTemporal.disabled= false
    cartaTemporal.innerHTML = "";
    
  }
0
  console.log(tiempo,movimientos,aciertos,ComenzoPartida)
  ...
  function Cronometro() {
    TiempoPartida = setInterval(() => {
      ...
      if (aciertos == 8) {
        ...
        ImprimirAciertos.innerHTML = `Aciertos: ${aciertos} WoW`;
        ImprimirMovimientos.innerHTML = `En solo  ${movimientos} movimientos`;
      }
    }, 1000); 
  }
